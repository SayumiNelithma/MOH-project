        ...
        <form onSubmit={addBaby}>
          ...
          <div className="row form-group mb-4">
            <div className="col">
              ...
              <input type="text" className="form-control" id="Name" name="Name" placeholder="Name" onChange={(e) => setName(e.target.value)} required />
            </div>

            <div className="col">
              <label htmlFor="Gender">Gender</label>
              <input type="text" className="form-control" id="Gender" name="Gender" placeholder="Gender" onChange={(e) => setGender(e.target.value)} required />
            </div>
          </div>
          ...
          <div className="row form-group mb-4">
            <div className="col">
              ...
              <input type="text" className="form-control" id="Weight" name="Weight" placeholder="Weight" onChange={(e) => setWeight(e.target.value)} required />
            </div>

            <div className="col">
              <label htmlFor="Height">Height</label>
              <input type="text" className="form-control" id="Height" name="Height" placeholder="Height" onChange={(e) => setHeight(e.target.value)} required />
            </div>
          </div>
          ...
          <div className="row form-group mb-4">
            ...
            <div className="col">
              ...
              <input type="tel" className="form-control" id="phone" name="phone" placeholder="07X-XXXXXXX" onChange={(e) => setphone(e.target.value)} required />
            </div>
          </div>
