...
export default function EditVaccine() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:9000/vaccinedetails/get/${id}`)
      .then((res) => {
  ...
  function updateVaccine(e) {
    ...
    axios
      .put(
        `http://localhost:9000/vaccinedetails/editvaccine/${id}`,
        updatedVaccine
      )
      .then(() => {
  ...
  const onDeleteClick = async () => {
    await axios
      .delete(`http://localhost:9000/vaccinedetails/deletecouple/${id}`)
      .then(() => {
