                        ...
                        <tbody>
                            {patient.map((patient, index) => (
                                <tr key={patient._id} className='col-sm-3 mb-3'>
                                    ...
                                    <td>
                                        <button className="btn btn-danger">Vaccination</button>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div style={{ display: 'flex' }}>
                                            <Link to={`/patient/update/${patient._id}`} className='btn btn-primary' style={{ marginBottom: '10px', marginRight: '10px' }}><BsBrushFill /></Link>
