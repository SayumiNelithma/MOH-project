            ...
            <div className="position-sticky pt-3 sidebar-sticky">
                <ul className="nav flex-column">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style={{ marginLeft: '150px', fontSize: '14px' }}>
                            ...
                            <a class="dropdown-item" href="/diseaseManagement/Home">account</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/patients/list"> Infectious disease Management</a>
                            <a class="dropdown-item" href="/AwarenessSession/display">non infectious disease management</a>
                            <a class="dropdown-item" href="/patients/list">patient management</a>
                            <a class="dropdown-item" href="/patients/list">report generation</a>
                            <div class="dropdown-divider"></div>
                        </div>
                    </li>
